...
(
    temperature,
    magnetic_field_df,
    bridge1_resistance_df,
    bridge2_resistance_df,
) = ppms.RvsH_dat_file_import(filename)
(
    fielddown,
    resistancedown,
    Hall_resistancedown,
    ...
    resistanceup,
    Hall_resistanceup,
) = ppms.get_RvsH_down_and_up(
    magnetic_field_df, bridge1_resistance_df, bridge2_resistance_df, min_field
)
...
FixedField, RxxAvg, FinalRxx, RxyAvg, FinalRxy = ppms.interpolate_and_symmetrize(
    fielddown,
    resistancedown,
    Hall_resistancedown,
    fieldup,
